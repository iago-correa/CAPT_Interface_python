...
PERIOD_DATES = {
    ...
    'PRE_END':          config('PERIOD_1_PRE_END', cast=tuple_of_ints),
    'TRAINING_START_1': config('PERIOD_2_TRAINING_BEGIN', cast=tuple_of_ints),
    'TRAINING_END_1':   config('PERIOD_2_TRAINING_END', cast=tuple_of_ints), 
    'TRAINING_START_2': config('PERIOD_3_TRAINING_BEGIN', cast=tuple_of_ints),
    'TRAINING_END_2':   config('PERIOD_3_TRAINING_END', cast=tuple_of_ints), 
    'POST_START':       config('PERIOD_4_POST_BEGIN', cast=tuple_of_ints),
    'POST_END':         config('PERIOD_4_POST_END', cast=tuple_of_ints),
    'DELAY_START':      config('PERIOD_5_DELAY_BEGIN', cast=tuple_of_ints),
